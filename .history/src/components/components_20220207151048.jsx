    ...
    <div className="">
      ...
      <div className="js-item">
        ...
        <div className="text-color">
          ...
          <br />
          {`const updateValue = (datafromChild) => {`} <br />
          {`setValue(datafromChild);`} <br />
          {`<ComponentB update={updateValue} />`} <br /> <br />
          {`<textarea onChange={(e) => props.update(e.target.value)}></textarea>`} <br />
        </div>{" "}
        <br />
        (We can pass function to child to component which change hook state. When function is executing in children component it passes value as parameter, changing )
      </div>
      <div className="js-item">
        {" "}
