    ...
    <div className="">
      ...
      <div className="js-item">
        ...
        <div className="text-color">
          ...
          {`)}`} <br /> <br />
          {`const Button = () => {`} <br />
          {`static contextType = ThemeColor; //Assign value to contextType to read value from available provider`} <br />
          {`return(`} <br />
          {`<div>`} <br /> 
        ...
        <br />
        (React Context provides passing values through whole tree. It should be used to pass global data like theme, information about logged user, set language of website. Static means a property that belongs to class only but not for it's instances.)
      </div>
      <div className="js-item">
        {" "}
