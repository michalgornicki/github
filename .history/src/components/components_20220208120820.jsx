    ...
    <div className="">
      ...
      <div className="js-item">
        ...
        <div className="text-color">
          ...
          {`const UserContext = React.createContext({name: 'guest'});`} <br /> <br />
      ...
      <div className="js-item">
        ...
        (React fragments gives possibility to group elements without adding new node to DOM. Fragments can be written with shortened form)
      </div>
    </div>
  );
};
