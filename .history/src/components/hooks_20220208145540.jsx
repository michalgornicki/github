...
useEffect(() => {
  ...
  return () => {
    subscription.unsubscribe();
        ...
        (Effect hook execute function or functions after every render of its component. React is cleaning buffer from effects from previous renders before new execution of U)
      </div>
      <div className="js-item">
        {" "}
