  ...
  return (
    <>
      ...
      <div className="js-item">
        ...
        This hook returns remembered (memoized) function. It will return new function only when one of passed dependencies will change.
      </div>
      <div className="js-item">
        {" "}
        ...
        This hook works similar to useCallback but returns remembered 
        ()
      </div>
      <div className="js-item">
        {" "}
