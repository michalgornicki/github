...
You can also put here setState() with conditional if statement.
          `}</pre>
        </div>{" "}
      </div>
      <div className="js-item">
...
You should put here timers, subscriptions and network requests cancellation.
          `}</pre>
        </div>{" "}
      </div>
      <div className="js-item">
        {" "}
        <div className="">static getDerivedStateFromError(error) </div>
        <div className="text-color">
        <pre>{`
This method executes after throwing and error.
Its error is is passed to this method as argument.
Method should return a value to update state.
          `}</pre>
        </div>{" "}
      </div>
      <div className="js-item">
        {" "}
        <div className="">componentDidCatch(error, info) </div>
        <div className="text-color">
        <pre>{`
This method executes after throwing and error.
It gets two arguments: throwed error and object with a componentStack key containing information about which component threw the error.
It should be used to save errors.
